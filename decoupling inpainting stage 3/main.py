...
def load_config(mode=None):
    ...
    parser.add_argument('--path', '--checkpoints', type=str, default='/mnt/sda/zhouying/decouple/checkpoints',
    ...
    if mode == 2:
        ...
        parser.add_argument('--output', type=str, default = '/mnt/sda/zhouying/decouple/multi-st/result',help='path to the output directory')
